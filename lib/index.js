...
var solve = function (points, values, parameters) {
    ...
    var params = {
        ...
        idToReturn: (_e = parameters === null || parameters === void 0 ? void 0 : parameters.idToReturn) !== null && _e !== void 0 ? _e : undefined,
    };
    ...
    if (params.population.length > 0) {
        ...
        populationWithFitness = getPopulationWithFitness_1.default(generatePopulation_1.default(points, params.populationAmount, params.idToReturn), values);
    }
    for (var i = 0, l = params.generations; i < l; i++) {
        ...
        var children = cross_1.default(parents, values, splitPosition, params.idToReturn);
        var firstChromosome = mutate_1.default(children[0].chromosome, params.mutate, params.idToReturn);
        var secondChromosome = mutate_1.default(children[1].chromosome, params.mutate, params.idToReturn);
        var firstChild = {
