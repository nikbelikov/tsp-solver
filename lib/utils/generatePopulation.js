...
exports.default = (function (points, size, idToReturn) {
    var population = [];
    var firstChromosome = getFirstChromosome_1.default(points, idToReturn);
    population.push(firstChromosome);
    for (var index = 0, length_1 = size - 1; index < length_1; index++) {
        population.push(generateChromosome_1.default(firstChromosome, idToReturn));
    }
    return population;
});
